        ...
        <div className="mx-4 w-full max-w-md rounded-lg border border-gray-200 bg-white p-6 shadow-xl">
          ...
          <div className="mb-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p id="conflict-dialog-description" className="mt-1 text-sm text-gray-600">
          ...
          {/* Hidden descriptions for button actions */}
          <p id="conflict-accept-desc" className="sr-only">
            Discard your local changes and accept the current server state.
          </p>
          <p id="conflict-retry-desc" className="sr-only">
            Attempt to re-apply your local changes on top of the server state.
          </p>
          <p id="conflict-dismiss-desc" className="sr-only">
            Close this dialog without taking action.
          </p>
          ...
          <div className="flex flex-col gap-2">
            <button
              ...
              aria-describedby="conflict-accept-desc"
            >
              Accept Server State
            </button>
            <button
              ...
              aria-describedby="conflict-retry-desc"
            >
              Retry My Changes
            </button>
            <button
              ...
              onClick={onDismiss}
              aria-describedby="conflict-dismiss-desc"
            >
              Dismiss
            </button>
          </div>
